...
export const TemplateSidebar = ({
  ...
  const [ConfirmDialog, confirm] = useConfirm(
    "Você tem certeza?",
    "Você está prestes a substituir o projeto atual por este modelo"
  )
  ...
  return (
    ...
    >
      ...
      <ToolSidebarHeader
        title="Paginas"
        description="Adicione e edite as paginas do seu projeto"
      />
      {isLoading && (
